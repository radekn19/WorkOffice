...
/*
 * 
 * This class checking current time and whether the link between Family and Employee was over.
 * 
 */
...
public class DateTime {
	...
	public DateTime() {
		...
		System.out.println("(DateTime) "+format.format(today) + "----- today");
		checkLinkDateTo();
	}
			...
			try {
				...
				if (equalsDays == true) {
					...
					int n = JOptionPane.showOptionDialog(null,
							eName + " " + eSurname + " ends up taking care of " + fName + " " + fSurname, "Expire date",
