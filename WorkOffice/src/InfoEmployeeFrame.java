...
public class InfoEmployeeFrame extends JFrame {
	...
	private JLabel setname,setsurname,setphone,setbirthdate,setcity,setpostcode,
	setstreet,sethousenr,setflatnr,setphysicalwork,setlanguage,setmarried,setexperience,setavailability;
	...
	public InfoEmployeeFrame() {
		...
		JLabel lblmarried = new JLabel("Mezaty/a");
