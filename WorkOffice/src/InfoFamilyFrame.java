...
public class InfoFamilyFrame extends JFrame
{
	...
	private JLabel setname,setsurname,setphone,setfamilyphone,setbirthdate,setcity,setpostcode,
					setstreet,sethousenr,setflatnr,setphysicalfit,setrate,setinfo,
					setlanguage,setphysicalwork,setexperience,setemployeeage;
	...
	public InfoFamilyFrame()
	{
		...
		lblAdres.setBounds(176, 11, 46, 14);
		panel.add(lblAdres);
		
		JLabel lblcity = new JLabel("Miejscowosc:");
		...
		JLabel lblfamilyphone = new JLabel("Tel.do rodziny:");
		...
		JLabel lblWymaganiaOdOpiekuna = new JLabel("Wymagania od opiekuna");
		lblWymaganiaOdOpiekuna.setBounds(128, 11, 159, 14);
		panel_2.add(lblWymaganiaOdOpiekuna);
